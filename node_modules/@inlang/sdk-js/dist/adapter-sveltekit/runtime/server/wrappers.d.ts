...
export declare const initHandleWrapper: (options: HandleOptions) => {
    use: (handle: WrappedHandle) => Kit.Handle;
};
export declare const initRootLayoutServerLoadWrapper: <LayoutServerLoad extends Kit.ServerLoad<any, any, any, any>>() => {
    use: <Data extends void | Record<string, any>>(load: (event: Parameters<LayoutServerLoad>[0], runtime: SvelteKitServerRuntime) => Data | Promise<Data>) => (event: Parameters<LayoutServerLoad>[0]) => Promise<Data & DataPayload>;
};
export declare const initServerLoadWrapper: <ServerLoad extends Kit.ServerLoad<any, any, any, any>>() => {
    use: <Data extends void | Record<string, any>>(fn: (event: Parameters<ServerLoad>[0], runtime: SvelteKitServerRuntime) => Data | Promise<Data>) => (event: Parameters<ServerLoad>[0]) => Promise<Data>;
};
export declare const initActionWrapper: <Action extends Kit.Action<any, any, any>>() => {
    use: <Data extends void | Record<string, any>>(fn: (event: Parameters<Action>[0], runtime: SvelteKitServerRuntime) => Data | Promise<Data>) => (event: Parameters<Action>[0]) => Promise<Data>;
};
export declare const initRequestHandlerWrapper: <RequestHandler extends Kit.RequestHandler<any, any>>() => {
    use: <Data extends void | Record<string, any>>(fn: (event: Parameters<RequestHandler>[0], runtime: SvelteKitServerRuntime) => Data | Promise<Data>) => (event: Parameters<RequestHandler>[0]) => Promise<Data>;
};
export {};
