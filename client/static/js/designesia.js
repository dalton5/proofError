...
jQuery(document).ready(function () {
					...
					(a.style.cssText =
						...
						(c = function () {
							r =
								...
								setTimeout(function () {
									u ||
										((a.style.height = '0'), (a.style.height = m.scrollHeight + 'px'), (r = null));
								}, 500);
						}),
						setTimeout(c, 10),
						Y('resize', c);
	...
	jQuery(
		'header,footer,.v-text,#controls,#nextslide,#prevslide,#subheader h1,#subheader h4,#slidecaption,#section-main'
	).addClass('wow');
	...
	function video_autosize() {
		jQuery('.de-video-container').each(function () {
			...
			var newheight =
				(height_1.substring(0, height_1.length - 2) - height_2.substring(0, height_2.length - 2)) /
				2;
	...
	$(document).ready(function () {
		...
		jQuery('.side-bg').each(function () {
			jQuery(this)
				...
				.css('height', jQuery(this).find('.image-container').parent().css('height'));
		});
